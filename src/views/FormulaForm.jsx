...
const generateDropdowns = (index) => {
  ...
  for (let i = 0; i < 6; i++) {
    ...
    dropdowns.push(
      <div className="relative  flex items-stretch" data-te-dropdown-ref>
        <select
    ...
    <>
      ...
      <div className="card animated fadeInDown">
        ...
        <form onSubmit={onSubmit}>
            ...
            <div className="py-12">
              ...
              <div className="md:flex ">
                ...
                <div className="mb-4">
                  ...
                  <input  value={formula.name} onChange={ev => setFormula({...formula, name: ev.target.value})} className="border rounded h-10 w-full focus:outline-none focus:border-green-200 px-2 mt-2 text-sm" placeholder="Nombre Formula*"/>
                </div>
                <div className="mb-4">
                ...
                <div className="mb-4">
                  ...
                  <input value={formula.percentage} onChange={ev => setFormula({...formula, percentage: ev.target.value})} type="text" name="mail" className="border rounded h-10 w-full focus:outline-none focus:border-green-200 px-2 mt-2 text-sm" placeholder="Porcentaje*"/>
                </div>
                </div>
                ...
                <input value={formula.estimated_time} onChange={ev => setFormula({...formula, estimated_time: ev.target.value})} className="border rounded h-10 w-full focus:outline-none focus:border-green-200 px-2 mt-2 text-sm" placeholder="Tiempo estimado*"/>
                </div>
                <div className="mb-4">
          ...
          <button className="float-right m-4 mt-6 pl-4 pt-1 pb-1 pr-4 bg-primary text-white font-medium w-36">{t('save')}</button>
        </form>
         )}
        <div>
        <button className={`m-4 mt-6 pl-4 pt-1 pb-1 pr-4 bg-primary text-white font-medium w-36" ${formula.phases && formula.phases.length >= 8 ? 'disabled' : ''}`}
                onClick={addPhase} 
    ...
    <div >
      ...
      <div className="grid md:grid-cols-4 md:gap-4">
          <div className="mb-4">
            ...
            <input className="border rounded h-10 w-full focus:outline-none focus:border-green-200 px-2 mt-2 text-sm"
              value={phase.delay_1}
        ...
        <div className="w-24 sm:w-28 h-60 flex items-center">
      ...
      data-te-dropdown-ref>
          ...
          <div className="m-6 ">
              <div
                  className="float-right m-4 mt-6 pl-4 pt-1 pb-1 pr-4 bg-primary text-white font-medium w-36">
              <button 
